...
export const VIDEO_MODELS: VideoModelConfig[] = [
  // OpenAI Sora
  {
    ...
    description: 'OpenAI Sora 2 video generation model (max 8s, 720x1280 or 1280x720)',
    provider: 'gpt',
  },
  // Google Veo
  {
    ...
    description: 'Google Veo 3.1 - latest preview version with audio support (max 8s, 16:9 or 9:16)',
    provider: 'gemini',
  },
  {
    ...
    supportsImageReference: true,
    supportsSoundGeneration: true,
    description: 'Google Veo 3.0 - preview version (max 8s, 16:9 or 9:16)',
    provider: 'gemini',
  },
];
